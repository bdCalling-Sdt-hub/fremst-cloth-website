...
const MyCompanyCloths = () => { 
    ...
    return (
        <div className={`${bigShoulders.className} pt-[80px] pb-[100px] container `} >
            {/* heading  */}
            <div className=' pb-[50px]'>
                <Heading className=' underline underline-offset-[12px] underline-primary   ' > MY COMPANY CLOTHS </Heading>
                <p className='border-b border-gray-300  '></p>
                <div className='flex items-center justify-end -mt-5'>
                    <button className={`bg-white border border-gray-300 text-[#000000] py-2 px-6 rounded-full font-semibold  text-[12px] tracking-wide ${plusJakarta.className} `}> View More </button>
                </div>
            </div> 
...
export default MyCompanyCloths;