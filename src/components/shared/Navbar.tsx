 ...
 954$
      ...
      <div className="p-2 w-[235px]">
        <p className="font-bold mb-1 text-[12px]">
          Remaining Credit: <span className='text-red-500'>  ${remainingCredit} </span> of ${totalCredit}
        </p>
        <p className="text-[12px]">
          You can still purchase items worth up to this amount. Be mindful of your budget!
        </p>
      </div>
        </div>
    );
    ...
    return (
        <div className={`${plusJakarta.className}`}>
            ...
            <div className=' bg-primary  h-[50px] flex items-center justify-center font-[400] lg:text-[14px] text-[14px] text-white tracking-wide '>
                Get high-quality workwear, protective gear, and tools at unbeatable wholesale prices! <span className=' font-semibold underline underline-offset-2 px-1'>Show more</span>
                <div className='ms-5'>
                    <ConfigProvider
                        theme={{
                            components: {
                ...
                <nav className="container  h-[100px]  relative z-10 w-full">
                    <div className="flex justify-between items-center h-full w-full ">
                        ...
                        <div className="flex items-center space-x-4">
                            <Link href={'/cart'} className='hidden md:flex' ><HiOutlineShoppingBag size={34} color='#292C61' /></Link>
                       
                            <Tooltip title={tooltipContent} color="white" overlayInnerStyle={{ color: 'rgba(0, 0, 0, 0.88)' , width:"290px" }}>
     <div className='border-2 border-primary w-10 h-10 rounded-full text-gray-600 flex items-center justify-center text-[12px] font-semibold'> 954$ </div>
    </Tooltip>

                            <Link href={'/profile'} className=' flex items-center gap-2' >
                                <Image src="/person.png" alt="" height={44} width={44} className="  rounded-full border-[2px] border-primary text-[16px]" />
                                <p>Asad</p>
                            </Link>
