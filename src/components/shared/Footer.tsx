    ...
    return (
        <footer className="bg-[#111229] text-[#EFFBF0]">
            <div className="container px-4 pt-16 pb-8">
                <div className=" flex lg:flex-row flex-col justify-between ">
                    ...
                    <div className="">
                        <div className="flex items-center ">
                            <Link href={'/'}>
                                <Image alt="Logo" src="/footerLogo.svg" width={145} height={55} />
                            </Link>
                        </div>
                        <p className={` ${rubik.className} text-[#EFFBF0] text-[15px] font-[400] pb-4 ps-2.5 py-[14px] tracking-wide w-[300px]`}> Helping you find and become a member of a Barcelona Cannabis club near you.</p>
                    ...
                    <div className="">
                        <div className="grid grid-cols-2 ">
                            {linkSections.map((section) => (
                                <div key={section.title} className='w-[227px]'>
                                    <h3 className={`font-bold mb-[30px] text-[24px] ${bigShoulders.className} text-white uppercase tracking-wide`}>{section.title}</h3>
                                    <ul className={`space-y-2 ${plusJakarta.className}`}>
                                        {section.links.map((link) => (
                                            <li key={link.label}>
                                                <a href={link.href} className=" transition-colors text-[16px] font-[400] text-[#BDBECE]">
                                                    {link.label}
                                                </a>
                                            </li>
                                        ))}
                    ...
                    <div>
                        <div className=" ">
                            <h3 className={`font-bold mb-[30px] text-[24px] ${bigShoulders.className} text-white uppercase tracking-wide`}>Newsletter</h3>
                            <p className={` mb-4 text-[16px] font-normal text-[#BDBECE] ${plusJakarta.className} tracking-wide`}>Subscribe to our newsletter for  exciting news & <br /> updates.</p> 
                ...
                {/* Copyright Section */}
                <div className={`mt-16 pt-8 border-t border-white/10 text-center ${plusJakarta.className} tracking-wide text-[#EBEBEB]`}>
